...
function fetchDeployHistory(_siteId, _accessToken, _proxyUrl, _maxDeploys = 10) {
  return console.warn("Deploy history fetching is disabled due to Netlify API CORS limitations. Only deploy triggering is available."), rxjs.of([]);
}
const initialState = {
  sites: [],
  deployHistory: {},
